...
<!-- Facebook metadata -->
<meta property="og:image" content="{{ !empty($meta['image']) ? $meta['image'] : url('images/logo.png') }}" />
...
<meta itemprop="image" content="{{ !empty($meta['image']) ? $meta['image'] : url('images/logo.png') }}" />
<!-- Twitter metadata -->
...
<meta name="twitter:image" content="{{ !empty($meta['image']) ? $meta['image'] : url('images/logo.png') }}" />
